...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(jQuery, $) {/* harmony import */ var _data_parameters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data/parameters */ "./data/parameters.ts");
//import * as $ from 'jquery'

function onButtonClick() {
    var url = _data_parameters__WEBPACK_IMPORTED_MODULE_0__["default"].url;
    var element = document.getElementById("id_HokkaidoTextBox");
    var output = document.getElementById("output");
    var request_text = element.value;
    var request_data = {
        body: {
            text: request_text
        }
